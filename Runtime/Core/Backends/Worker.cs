...
[assembly: InternalsVisibleTo("Unity.InferenceEngine.PerformanceTests")]
...
namespace Unity.InferenceEngine
{
    ...
    public class Worker : IDisposable
    {
        ...
        ///
        /// The reference is only valid until you call <see cref="Schedule" />, <see cref="ScheduleIterable" />, or <see cref="Dispose" /> on the worker.
        /// </remarks>
        ...
        /// <summary>
        /// Returns a reference to the output tensor at this index. This is non-blocking.
        /// </summary>
        /// <remarks>
        /// The reference is only valid until you call <see cref="Schedule" />, <see cref="ScheduleIterable" />, or <see cref="Dispose" /> on the worker.
        ///
        /// The index parameter is the index of the <see cref="Model.Output" /> in the List <see cref="Model.outputs" />.
        /// </remarks>
        ...
        /// <summary>
        /// Returns a reference to the output tensor for the model output with this name. This is non-blocking.
        /// </summary>
        /// <remarks>
        /// The reference is only valid until you call <see cref="Schedule" />, <see cref="ScheduleIterable" />, or <see cref="Dispose" /> on the worker.
        /// </remarks>
