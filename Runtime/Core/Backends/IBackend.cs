...
[assembly: InternalsVisibleTo("Unity.InferenceEngine.TestsUtils")]
...
namespace Unity.InferenceEngine
{
    ...
    interface IBackend : IDisposable
    {
        ...
        void DepthToSpace(Tensor X, Tensor O, int blocksize, Layers.DepthToSpaceMode mode);
        ...
        /// <param name="O">The output tensor to be computed and filled.</param>
        /// <param name="blocksize">The size of the blocks to move the depth data into.</param>
        void SpaceToDepth(Tensor X, Tensor O, int blocksize);
        ...
        /// <param name="allowNegativeIndexes">Whether to consider negative indices as counting from back of dimension.</param>
        void OneHot(Tensor<int> indices, Tensor<int> O, int axis, int depth, int offValue, int onValue, bool allowNegativeIndexes);
        ...
        /// <param name="onValue">The value to use for an on element.</param>
        /// <param name="allowNegativeIndexes">Whether to consider negative indices as counting from back of dimension.</param>
        void OneHot(Tensor<int> indices, Tensor<float> O, int axis, int depth, float offValue, float onValue, bool allowNegativeIndexes);
        ...
        /// <param name="coordinateTransformationMode">Whether to shift the input coordinates by half pixels.</param>
        void RoiAlign(Tensor<float> X, Tensor<float> rois, Tensor<int> indices, Tensor<float> O, Layers.RoiPoolingMode mode, int outputHeight, int outputWidth, int samplingRatio, float spatialScale, Layers.RoiCoordinateTransformationMode coordinateTransformationMode);
        ...
        /// </summary>
        void Mish(Tensor<float> X, Tensor<float> O);
        ...
        void TopK(Tensor<int> X, Tensor<int> values, Tensor<int> indices, int k, int axis, bool largest);
