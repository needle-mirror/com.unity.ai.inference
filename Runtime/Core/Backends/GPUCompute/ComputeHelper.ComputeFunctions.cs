...
namespace Unity.InferenceEngine
{
    ...
    {
        // Compute Shaders
        static ComputeShader k_TextureToTensor = Resources.Load<ComputeShader>("InferenceEngine/TextureConversion/TextureToTensor");
        static ComputeShader k_TensorToTexture = Resources.Load<ComputeShader>("InferenceEngine/TextureConversion/TensorToTexture");
        static ComputeShader k_AxisActivations = Resources.Load<ComputeShader>("InferenceEngine/ComputeShaders/AxisActivations");
        static ComputeShader k_CumSum = Resources.Load<ComputeShader>("InferenceEngine/ComputeShaders/CumSum");
        static ComputeShader k_ReferenceImpl = Resources.Load<ComputeShader>("InferenceEngine/ComputeShaders/ReferenceImpl");
        ...
        static ComputeShader k_GemmT = Resources.Load<ComputeShader>("InferenceEngine/ComputeShaders/GemmT");
        static ComputeShader k_Pool = Resources.Load<ComputeShader>("InferenceEngine/ComputeShaders/Pool");
        static ComputeShader k_Normalization = Resources.Load<ComputeShader>("InferenceEngine/ComputeShaders/Normalization");
        static ComputeShader k_NMS = Resources.Load<ComputeShader>("InferenceEngine/ComputeShaders/NMS");
        static ComputeShader k_ReduceIndices = Resources.Load<ComputeShader>("InferenceEngine/ComputeShaders/ReduceIndices");
        static ComputeShader k_CopyOps = Resources.Load<ComputeShader>("InferenceEngine/ComputeShaders/CopyOps");
        static ComputeShader k_Random = Resources.Load<ComputeShader>("InferenceEngine/ComputeShaders/Random");
        static ComputeShader k_IndexingOps = Resources.Load<ComputeShader>("InferenceEngine/ComputeShaders/IndexingOps");
        static ComputeShader k_SortingOps = Resources.Load<ComputeShader>("InferenceEngine/ComputeShaders/SortingOps");
        static ComputeShader k_ScatterOps = Resources.Load<ComputeShader>("InferenceEngine/ComputeShaders/ScatterOps");
        static ComputeShader k_GridSample = Resources.Load<ComputeShader>("InferenceEngine/ComputeShaders/GridSample");
        static ComputeShader k_Resize = Resources.Load<ComputeShader>("InferenceEngine/ComputeShaders/Resize");
        static ComputeShader k_ImageBased = Resources.Load<ComputeShader>("InferenceEngine/ComputeShaders/ImageBased");
        static ComputeShader k_BroadcastGen = Resources.Load<ComputeShader>("InferenceEngine/ComputeShaders/Compute.Shaders.Broadcast.gen");
        static ComputeShader k_ConvGen = Resources.Load<ComputeShader>("InferenceEngine/ComputeShaders/Compute.Shaders.Conv.gen");
        static ComputeShader k_ConvTransposeGen = Resources.Load<ComputeShader>("InferenceEngine/ComputeShaders/Compute.Shaders.ConvTranspose.gen");
        static ComputeShader k_ReductionGen = Resources.Load<ComputeShader>("InferenceEngine/ComputeShaders/Compute.Shaders.Reduction.gen");
        static ComputeShader k_ReductionUnrolledGen = Resources.Load<ComputeShader>("InferenceEngine/ComputeShaders/Compute.Shaders.ReductionUnrolled.gen");
        static ComputeShader k_PointwiseUnaryGen = Resources.Load<ComputeShader>("InferenceEngine/ComputeShaders/Compute.Shaders.PointwiseUnary.gen");
        static ComputeShader k_GenericA = Resources.Load<ComputeShader>("InferenceEngine/ComputeShaders/ReferenceImpl.GenericA");
        static ComputeShader k_PadA = Resources.Load<ComputeShader>("InferenceEngine/ComputeShaders/ReferenceImpl.PadA");
        static ComputeShader k_PoolA = Resources.Load<ComputeShader>("InferenceEngine/ComputeShaders/ReferenceImpl.PoolA");
        static ComputeShader k_Einsum = Resources.Load<ComputeShader>("InferenceEngine/ComputeShaders/ReferenceImpl.Einsum");
        static ComputeShader k_IndexingOpsA = Resources.Load<ComputeShader>("InferenceEngine/ComputeShaders/ReferenceImpl.IndexingOpsA");
        static ComputeShader k_Logical = Resources.Load<ComputeShader>("InferenceEngine/ComputeShaders/ReferenceImpl.Logical");
        static ComputeShader k_BitonicSort = Resources.Load<ComputeShader>("InferenceEngine/ComputeShaders/BitonicSort");
        static ComputeShader k_RoiAlignShader = Resources.Load<ComputeShader>("InferenceEngine/ComputeShaders/RoiAlign");
        ...
        public static ComputeFunction k_Conv1D_Generic = new ComputeFunction(k_ConvGeneric, "Conv1D_Generic");
        public static ComputeFunction k_Conv3D_1x1_Generic = new ComputeFunction(k_ConvGeneric, "Conv3D_1x1_Generic");
        public static ComputeFunction k_Conv2D_1x1_Generic = new ComputeFunction(k_ConvGeneric, "Conv2D_1x1_Generic");
        public static ComputeFunction k_Conv1D_1x1_Generic = new ComputeFunction(k_ConvGeneric, "Conv1D_1x1_Generic");
        ...
        public static ComputeFunction k_TopK = new ComputeFunction(k_SortingOps, "TopK");
        public static ComputeFunction k_ScatterND = new ComputeFunction(k_ScatterOps, "ScatterND");
        ...
        public static ComputeFunction k_Mish = new ComputeFunction(k_PointwiseUnaryGen, "Mish");
        ...
        public static ComputeFunction k_Transpose = new ComputeFunction(k_GenericA, "Transpose");
        public static ComputeFunction k_InstanceNormalizationTail = new ComputeFunction(k_GenericA, "InstanceNormalizationTail");
        public static ComputeFunction k_PadBorderND = new ComputeFunction(k_PadA, "PadBorderND");
        public static ComputeFunction k_PadReflectND = new ComputeFunction(k_PadA, "PadReflectND");
        public static ComputeFunction k_PadSymmetricND = new ComputeFunction(k_PadA, "PadSymmetricND");
        public static ComputeFunction k_PadEdgeND = new ComputeFunction(k_PadA, "PadEdgeND");
        public static ComputeFunction k_PadWrapND = new ComputeFunction(k_PadA, "PadWrapND");
        public static ComputeFunction k_MaxPool2D = new ComputeFunction(k_PoolA, "MaxPool2D");
        public static ComputeFunction k_AveragePool2D = new ComputeFunction(k_PoolA, "AveragePool2D");
        public static ComputeFunction k_MaxPool1D = new ComputeFunction(k_PoolA, "MaxPool1D");
        public static ComputeFunction k_AveragePool1D = new ComputeFunction(k_PoolA, "AveragePool1D");
        public static ComputeFunction k_EinsumOne = new ComputeFunction(k_Einsum, "EinsumOne");
        public static ComputeFunction k_EinsumTwo = new ComputeFunction(k_Einsum, "EinsumTwo");
        public static ComputeFunction k_Tile = new ComputeFunction(k_IndexingOpsA, "Tile");
        public static ComputeFunction k_Gather = new ComputeFunction(k_IndexingOpsA, "Gather");
        public static ComputeFunction k_GatherElementsFast = new ComputeFunction(k_IndexingOpsA, "GatherElementsFast");
        public static ComputeFunction k_GatherElements = new ComputeFunction(k_IndexingOpsA, "GatherElements");
        public static ComputeFunction k_ScatterElementsFast = new ComputeFunction(k_IndexingOpsA, "ScatterElementsFast");
        public static ComputeFunction k_ScatterElements = new ComputeFunction(k_IndexingOpsA, "ScatterElements");
        public static ComputeFunction k_Expand = new ComputeFunction(k_IndexingOpsA, "Expand");
        public static ComputeFunction k_Slice = new ComputeFunction(k_IndexingOpsA, "Slice");
        public static ComputeFunction k_Where = new ComputeFunction(k_Logical, "Where");
