Shader "Hidden/InferenceEngine/TextureConversion/TextureToTensor"
{
    Properties
    {
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(v2f i, UNITY_VPOS_TYPE screenPos : VPOS) : SV_Target
            {
                ...
                bool3 mask = colorO.rgb > 0.0031308f;
                colorO.rgb = lerp(12.92f * colorO.rgb, 1.055f * pow(abs(colorO.rgb), 0.41666666666f) - 0.055f, mask);
                #endif
