Shader "Hidden/InferenceEngine/Activation"
{
    Properties
    {
    }
    SubShader
    {
        ...
        {
            CGPROGRAM
            #pragma multi_compile_local Relu Selu Abs Neg Ceil Floor Round Reciprocal Swish Tanh Softplus Sigmoid HardSigmoid Relu6 Mish Elu LeakyRelu Exp Log Sqrt Acos Acosh Asin Asinh Atan Atanh Cos Cosh Sin Sinh Tan Pow Clip Erf Sign Square Celu HardSwish Softsign ThresholdedRelu Gelu GeluFast Shrink
            ...
            float4 frag(v2f i, UNITY_VPOS_TYPE screenPos : VPOS) : SV_Target
            {
                ...
                #endif
                #ifdef LeakyRelu
                    v = 0.5f * ((1.0f + Alpha) * v + (1.0f - Alpha) * abs(v));
                #endif
                #ifdef Exp
                    v = exp(v);
                #endif
